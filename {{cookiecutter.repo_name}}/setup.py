...
DEV_{{ cookiecutter.package_name }} = literal_eval(os.environ.get('DEV_{{ cookiecutter.package_name }}', '0'))
...
def read(*names, **kwargs):
    if DEV_{{ cookiecutter.package_name }}:
        return ''
...
setup(
    ...
    use_scm_version=not DEV_{{ cookiecutter.package_name }},
